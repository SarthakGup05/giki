    ...
    <>
      ...
      <div className="container mx-auto p-4 md:p-6 lg:p-8 space-y-10">
        ...
        <div className="additional-about flex flex-col md:flex-row bg-gradient-to-r from-white via-gray-100 to-white p-6 md:p-8 rounded-xl shadow-lg mb-8">
          ...
          <div className="flex-1 flex flex-col justify-center md:pr-6 lg:pr-8 space-y-4 font-semibold">
          ...
          {/* Right side: Image */}
          <div className="flex-1 flex items-center justify-center mt-4 md:mt-0 md:pl-6 lg:pl-8">
            <img
        ...
        {/* Description Section */}
        <div className="description bg-white p-6 md:p-8 rounded-lg shadow-md mt-8 font-semibold">
