...
const LoveStoryVilla = () => {
  const images = [
    "/assets/images/Lovevilla/1.avif",
    "/assets/images/Lovevilla/2.avif",
    "/assets/images/Lovevilla/3.avif",
    "/assets/images/Lovevilla/4.avif",
    "/assets/images/Lovevilla/5.avif",
    "/assets/images/Lovevilla/6.avif",
    "/assets/images/Lovevilla/7.avif",
    "/assets/images/Lovevilla/8.jpg",
    "/assets/images/Lovevilla/9.jpg",
     "/assets/images/Lovevilla/10.jpg",
    "/assets/images/Lovevilla/11.jpg",
    "/assets/images/Lovevilla/12.jpg",
    "/assets/images/Lovevilla/13.jpg",
    "/assets/images/Lovevilla/14.jpg",
    "/assets/images/Lovevilla/15.jpg",
  ...
  return (
    <div className="bg-white text-black">
      ...
      <div className="w-full h-[60vh] grid grid-cols-4 grid-rows-2 gap-2 p-2">
        <img
          src="/assets/images/Lovevilla/7.avif"
          alt="Villa Image 1"
      ...
      <div className="px-4 py-8 max-w-6xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-bold mb-4">
          Villa No. 1 & 9 With 3 Bedroom Set and Private Pool
        </h1>
        <p className="text-lg text-gray-700 mb-6">
          Nestled in the heart of Siolim, this 3BHK Portuguese-style villa
          offers a private pool and a unique blend of modern amenities and
          vintage charm. Ideal for up to 6 adults and 3 children, this property
          promises a peaceful getaways with high-speed WiFi, a fully equipped
          kitchen, 24-hour power backup, and in-villa services like a chef and
          housekeeping.
        </p>
