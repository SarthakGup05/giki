...
const slides = [
  {
    ...
    subtitle: "",
    description:
      "Discover our diverse range of room fresheners, crafted to bring a refreshing and long-lasting aroma to your spaces. Made with natural ingredients, they ensure a sustainable and delightful experience.",
    image: "/assets/images/page banner/room freshner.png",
    alt: "Room Fresheners",
    badge: "New Arrival",
          ...
          <div key={slide.id} className="relative h-[80vh] flex items-center">
            ...
            <div className="relative container mx-auto px-4 md:px-8 flex items-center h-full">
              ...
              >
                {/* Badge */}
                <motion.span
                  className=" hidden px-4 py-1 bg-orange-500 text-white text-sm font-medium rounded-full mb-6"
                ...
                <div className="text-center">
                  <motion.button
                    className="px-4 py-3 mt-24 bg-blue-500 text-white rounded-full font-medium text-lg hover:bg-blue-600 transition-colors shadow-lg hover:shadow-blue-500/30"
                    initial={{ opacity: 0, y: 30 }}
                    animate={{ opacity: 1, y: 0 }}
