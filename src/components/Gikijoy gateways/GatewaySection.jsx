            ...
            {getaways.map((getaways, index) => (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 text-left text-white">
                  <h3 className="text-2xl font-semibold mb-2">{getaways.title}</h3>
                  <p className="text-sm mb-4">{getaways.description}</p>
                  <Link to={getaways.route}>
                    <motion.button
