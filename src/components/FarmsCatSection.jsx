  ...
  return (
    <section className="py-16 bg-gray-100">
      <div className="container mx-auto px-6 md:px-12 text-center">
        <h2 className="text-4xl font-bold text-gray-800 mb-4">Explore our variety products</h2>
        <p className="text-lg text-gray-600 max-w-xl mx-auto mb-12">
          Explore our variety of products and find the perfect gift for your loved ones.
        </p>
